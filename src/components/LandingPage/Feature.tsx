...
const features = [
  ...
  return (
    ...
    className="py-20 lg:py-40 flex flex-col justify-center items-center"
    >
      <motion.h1 
        variants={{
      ...
      <motion.h3 
        ...
        className="text-neutral-600 text-center max-w-3xl font-normal text-xl mb-4"
      >
        ExpensWise comes packed with everything you need to manage your expenses efficiently.
      </motion.h3>
      <motion.div 
        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-10 md:gap-5 max-w-7xl mx-auto"
      >
      {
        features.map((feat, i) => (
          <motion.div
