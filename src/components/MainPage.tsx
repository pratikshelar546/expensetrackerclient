...
const MainPage = () => {
  return (
    <main className="w-full min-h-screen flex flex-col items-center overflow-x-hidden overflow-y-hidden">
      <section className="relative w-full h-full min-h-[calc(100vh-3.6rem)] flex flex-col items-center justify-start border-b border-blue-500/50 mt-14">
        {/* <Spotlight
        className="-top-40 left-0 md:left-60 md:-top-20"
        fill="#ffe4e4"
        /> */}
        {/* -z-10 absolute -top-10 left-[calc(40%)] w-[100%] h-[calc(100vh-12rem)] */}
        <div className="-z-10 absolute left-[calc(28%)] w-[100%] h-[calc(100vh-12rem)]">
        ...
        <div className="text-white w-2xl max-h-[calc(100vh-16rem)] grow max-w-6xl px-4 mx-4 flex flex-col justify-center gap-6">
          <motion.h1
